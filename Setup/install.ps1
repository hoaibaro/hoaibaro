...
# MODULE LOADING
try {
    Import-Module -Name $PSScriptRoot\Modules\WindowsFeatures.psm1
}
catch {
    Write-Error "Module Error: $($_.Exception.Message)"
    try {
        Add-Type -AssemblyName System.Windows.Forms
        [System.Windows.Forms.MessageBox]::Show($_.Exception.Message, "Module Error", "OK", "Error")
    }
    catch {}
    exit 1
}
