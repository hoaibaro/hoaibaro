...
function Invoke-RenameDialog {
    ...
    $renameButton.Add_Click({
            ...
            # Disable button �? tr�nh click nhi?u l?n
            ...
            if ($confirmResult -eq [System.Windows.Forms.DialogResult]::Yes) {
                try {
                    ...
                    # H?i user c� mu?n restart ngay kh�ng
...
function Set-UserPassword {
    ...
    try {
        # Ki?m tra xem ng�?i d�ng c� �ang d�ng Windows Hello PIN kh�ng
        $pinEnabled = $false
        try {
        ...
        # N?u �ang d�ng PIN, v� hi?u h�a t?m th?i
        if ($pinEnabled) {
            try {
                # L�u tr?ng th�i PIN hi?n t?i
        ...
        # N?u kh�ng d�ng PIN ho?c x? l? PIN th?t b?i, d�ng ph��ng ph�p th�ng th�?ng
        $methods = @(
            {
                # Ph��ng ph�p 1: S? d?ng LocalAccount module
                try {
...
function Invoke-DomainJoinOperation {
    ...
    if ($null -eq $Password) { throw "Password is required." }
    ...
    try {
        ...
        [System.Windows.Forms.MessageBox]::Show("Successfully joined domain '$DomainName'. A restart is required.", "Success", [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Information)
        
        $restart = [System.Windows.Forms.MessageBox]::Show("Do you want to restart now?", "Restart Required", [System.Windows.Forms.MessageBoxButtons]::YesNo, [System.Windows.Forms.MessageBoxIcon]::Question)
        ...
        throw # Main Function Provisioing Run All Processes
function Invoke-RunAllOperations {param([System.Windows.Forms.Form]$mainForm)
    Hide-MainMenu
    # Create status form
    $statusForm = New-Object System.Windows.Forms.Form
